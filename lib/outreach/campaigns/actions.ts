  ...
  try {
    const [row] = await db
      ...
      .values({
        ...
        ...(input.email_1_template !== undefined && { email1Template: input.email_1_template }),
        ...(input.email_2_template !== undefined && { email2Template: input.email_2_template }),
        ...(input.email_3_template !== undefined && { email3Template: input.email_3_template }),
        email1SubjectTemplate: input.email_1_subject_template || null,
        email2SubjectTemplate: input.email_2_subject_template || null,
        email3SubjectTemplate: input.email_3_subject_template || null,
